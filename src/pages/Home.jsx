...
export function Home() {
  ...
  return (
    mostrarResultado === false ? (
      ...
      <CardContainer>
        <img src={thankYouImg} alt="img obrigada" />
        ...
        <p>Agradecemos por deedicar um momento para nos avaliar. Se precisar de mais suporte, não hesite em entrar em contato!</p>
